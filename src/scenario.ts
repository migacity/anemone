...
export const scenario: Scenario[] = [
  ...
  // 立ち絵 A６
  { type: "showCharacter", name: "sekak", face: "chara_A6", continue: true },
  { type: "text", text: "「聞こえてない？」", continue: false },
  // 立ち絵 A2
  { type: "showCharacter", name: "sekak", face: "chara_A2", continue: true },
  { type: "text", text: "「聞こえていませんか～？」", continue: false },
  // 立ち絵 A５
  { type: "showCharacter", name: "sekak", face: "chara_A5", continue: true },
  { type: "text", text: "「あ…つながった」", continue: false },
  // 立ち絵 A3
  { type: "showCharacter", name: "sekak", face: "chara_A3", continue: true },
  { type: "text", text: "「こんにちわ」", continue: false },
  { type: "text", text: "「初めまして」", continue: false },
  { type: "text", text: "「私の名前は世界と言います」", continue: false },
  // 立ち絵 B６
  { type: "showCharacter", name: "sekak", face: "chara_B6", continue: true },
  {
    type: "text",
  ...
  // 立ち絵 B５
  { type: "showCharacter", name: "sekak", face: "chara_B5", continue: true },
  {
    type: "text",
  ...
  // 立ち絵 B1
  { type: "showCharacter", name: "sekak", face: "chara_B1", continue: true },
  {
    type: "text",
  ...
  // 立ち絵 B４
  { type: "showCharacter", name: "sekak", face: "chara_B4", continue: true },
  {
    type: "text",
  ...
  { type: "background", name: "whiteroom", continue: true },
  // 立ち絵 A1
  { type: "showCharacter", name: "sekak", face: "chara_A1", continue: true },
  ...
  // 立ち絵 B2
  { type: "showCharacter", name: "sekak", face: "chara_B2", continue: true },
  ...
  // 立ち絵 A４
  { type: "showCharacter", name: "sekak", face: "chara_A4", continue: true },
  { type: "text", text: "「…」" },
  // 立ち絵 B３
  { type: "showCharacter", name: "sekak", face: "chara_B3", continue: true },
