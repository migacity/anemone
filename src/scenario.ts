...
import bench from "../assets/bg-bench.jpg";
import fieldOfFlowers from "../assets/bg-field-of-flowers.jpg";
import garden from "../assets/bg-garden.jpg";
import hospitalDaytime from "../assets/bg-hospital-daytime.jpg";
import hospitalEvening from "../assets/bg-hospital-evening.jpg";
import livingRoom from "../assets/bg-living-room.jpg";
import park from "../assets/bg-park.jpg";
import restaurant from "../assets/bg-restaurant.jpg";
import room from "../assets/bg-room.jpg";
import ruins from "../assets/bg-ruins.jpg";
import whiteroom from "../assets/bg-whiteroom.jpg";
import chara_A1 from "../assets/chara-A1.png";
import chara_A2 from "../assets/chara-A2.png";
import chara_A3 from "../assets/chara-A3.png";
import chara_A4 from "../assets/chara-A4.png";
import chara_A5 from "../assets/chara-A5.png";
import chara_A6 from "../assets/chara-A6.png";
import chara_B1 from "../assets/chara-B1.png";
import chara_B2 from "../assets/chara-B2.png";
import chara_B3 from "../assets/chara-B3.png";
import chara_B4 from "../assets/chara-B4.png";
import chara_B5 from "../assets/chara-B5.png";
import chara_B6 from "../assets/chara-B6.png";
